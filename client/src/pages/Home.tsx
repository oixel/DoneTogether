...
const AuthDebug: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 right-0 bg-white p-4 border shadow-lg text-xs max-w-xs overflow-auto">
      <pre>
        Auth: {JSON.stringify({ isLoaded, isSignedIn, userId }, null, 2)}
      </pre>
      {user && (
        <pre className="mt-2">
          User: {JSON.stringify({
